...
public class JdbcTemplatePersonDao2 implements PersonDao {
    private JdbcTemplate jdbcTemplate;

    public JdbcTemplatePersonDao2(DataSource dataSource) {
    ...
    @Override
    public List<Person> select(final int start, final int size) {
